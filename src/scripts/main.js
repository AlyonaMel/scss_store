...
const modalThumbsSwiper = new Swiper('.modal-product__thumbs', {
  spaceBetween: 38,
  slidesPerView: 'auto',
  slidesPerGroup: 1,
  watchSlidesProgress: true,
...
const modalPreviewSwiper = new Swiper('.modal-product__preview', {
  slidesPerView: 1,
  slidesPerGroup: 1,
  spaceBetween: 16,
...
let menuLinks = menu.querySelectorAll('.burger__menu-link');
